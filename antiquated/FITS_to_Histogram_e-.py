...
if __name__ == "__main__":
    ...
    exptime_value = 60.00  # Exposure time
    ...
    try:
        ...
        for (gain, set_temp), file_list in groups.items():
            ...
            try:
                ...
                if fit_params:
                    ...
                    plt.savefig(plot_path, dpi=600)  # Increased DPI for higher resolution
                    plt.close()
        ...
        if all_electron_counts:
            ...
            # Adjust x-axis limits from 8 to 16 electron counts
            plt.xlim(8, 16)
            ...
            plt.savefig(overlay_plot_path, dpi=600)  # Increased DPI for higher resolution
            plt.close()
